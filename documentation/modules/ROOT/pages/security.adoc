...
Quarkus provides an integration to the https://github.com/eclipse/microprofile-jwt-auth[MicroProfile JWT RBAC,window=_blank] spec.
...
== Invoke the /secure/claim endpoint with incorret RBAC
...
You can check the `403 Forbidden` response.