...
The output changes form `java.net.UnknownHostException: www.fruityvice.com` (or any other network related exception) in the first calls to `org.eclipse.microprofile.faulttolerance.exceptions.CircuitBreakerOpenException: getFruitByName` when circuit is opened.
