...
:doc-sec: fault-tolerance-no-network
include::ROOT:partial$invoke-service.adoc[tag=call]
...
=== Invoke Service
:doc-sec: fault-tolerance-circuit-breaker
:k8s-cli: k8s
:path: fruit/banana
:k8s-env: minikube
:cli-tool: curl
...
:doc-sec: container-run-health-check
...
:doc-sec: rebuild-custom-health-check
include::ROOT:partial$build-containers.adoc[tag=build]
...
:doc-sec: container-run-custom-health-check
include::ROOT:partial$build-containers.adoc[tag=run]
...
:doc-sec: container-push-custom-health-check
include::ROOT:partial$build-containers.adoc[tag=tag-push]

[#qext-custom-health-check-k8s-delete-resources]
=== Delete Kubernetes Resources
:doc-sec: custom-probes-delete
include::ROOT:partial$k8s-build-deploy.adoc[tag=k8s-delete]
...
:doc-sec: deploy-custom-health-check
include::ROOT:partial$k8s-build-deploy.adoc[tag=k8s-deploy]

[#qext-custom-health-check-invoke-k8s-svc]
=== Invoke Kubernetes Service

:doc-sec: k8s-invoke-custom-health-check
include::ROOT:partial$k8s-build-deploy.adoc[tag=k8s-invoke-svc]

[#qext-custom-health-check-end-k8s-delete-resources]
=== Delete Kubernetes Resources

:doc-sec: health-check-resources-extension
include::ROOT:partial$k8s-build-deploy.adoc[tag=k8s-delete]