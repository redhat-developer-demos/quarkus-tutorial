...
which allows you to run this entire tutorial within contianer that will have all tools configured.
====
...
[source,bash]
-----
docker pull quay.io/rhdevelopers/tutorial-tools:0.0.1
-----
