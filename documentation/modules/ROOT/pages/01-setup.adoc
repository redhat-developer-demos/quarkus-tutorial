...
[WARNING]
====
If you're running locally, your only requirements are Java 11 and Maven 3.6.0+. You can use Java 8, but support for native compilation will be disabled soon.

GraalVM is only required if you intend to build a native image.

Docker is only required if you want to build a container.
====
