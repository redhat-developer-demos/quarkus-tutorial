...
----
./mvnw quarkus:remove-extension -D"extensions=quarkus-resteasy-reactive"
./mvnw quarkus:add-extension -D"extensions=quarkus-spring-web,quarkus-spring-data-jpa,quarkus-resteasy-reactive-jackson"
----
