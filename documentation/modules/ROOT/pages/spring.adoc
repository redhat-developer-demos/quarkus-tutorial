...
[source,bash]
----
mvn quarkus:add-extension -Dextensions=quarkus-spring-web,quarkus-spring-data-jpa
----
...
IMPORTANT: The extensions above require `quarkus-resteasy-jackson` or `quarkus-resteasy-reactive-jackson`.
In order to be conservative with our dependencies, please change in `pom.xml` the extension `quarkus-reasteasy` 
