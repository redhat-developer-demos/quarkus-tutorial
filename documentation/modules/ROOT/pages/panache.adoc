...
More info https://quarkus.io/guides/hibernate-orm-panache-guide[Panache Guide, window="_blank"]
...
You can insert a new fruit by using the  command: 
...
Or use the Swagger UI at http://localhost:8080/swagger-ui[window="_blank"] to try your REST endpoints. 
