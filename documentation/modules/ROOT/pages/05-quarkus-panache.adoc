...
To demonstrate using Hibernate with Panache, you will be developing an application called "Fruits". It's a simple CRUD REST API that handles information about Fruits.

For the demonstration we will use https://mariadb.org/[MariaDB] as the backing database.
