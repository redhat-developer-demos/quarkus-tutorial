...
[WARNING]
====
If you're running locally, your only requirements are Java 11 and Maven 3.6.2+. You can use Java 8, but support for native compilation will be disabled soon.
